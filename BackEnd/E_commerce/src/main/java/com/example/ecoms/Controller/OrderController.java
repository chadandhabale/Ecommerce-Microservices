...
public class OrderController {
    ...
    public ResponseEntity<List<OrderDTO>> getOrdersByStatus(@PathVariable Status status) {
        ...
        return ResponseEntity.ok(orderService.findByOrderStatus(status)); // ✅ FIXED
    }
}
